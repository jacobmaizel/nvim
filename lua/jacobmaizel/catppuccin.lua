-- https://github.com/fang2hou/8f87a43c02c26463b1689736cbc3b09e (new stuff)
-- and https://github.com/catppuccin/nvim/discussions/323?sort=top#discussioncomment-5287724 (original)
--
  ...
  highlight_overrides = {
    all = function(colors)
      return {
        ...
        -- yaml rule specific
        ["@rule_binding"] = { fg = colors.yellow, },

        -- go specific
        ["@function.method.go"] = { fg = colors.green },
        ...
        -- cucumber specific
        -- given
        ["cucumberGivenRegion"] = { fg = colors.blue, style = { "bold", "italic", "underline" } },
        ["cucumberGivenAndRegion"] = { fg = colors.blue },
        ["cucumberGivenTable"] = { fg = colors.subtext1, style = { "bold" } },

        -- then
        ["cucumberThenRegion"] = { fg = colors.teal, style = { "bold", "italic", "underline" } },
        ["cucumberThenAndRegion"] = { fg = colors.teal },
        ["cucumberThenTable"] = { fg = colors.subtext1, style = { "bold" } }
